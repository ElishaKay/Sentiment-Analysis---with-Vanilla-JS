...
create table article (
    ...
    article_uuid varchar(50) UNSIGNED NOT NULL,
    article_title varchar(50) UNSIGNED DEFAULT NULL,
    article_creation_date timestamp NULL DEFAULT NULL,
    foreign key(article_uuid) references sentiment(article_uuid)
);
...
create table sentiment_model (
    ...
    sentiment_model_title varchar(50) UNSIGNED NOT NULL,
    sentiment_model_description varchar(500) UNSIGNED NOT NULL, 
    foreign key(sentiment_model_id) references company_sentiment(sentiment_model_id),
    foreign key(sentiment_model_id) references article_sentiment(sentiment_model_id)
);
